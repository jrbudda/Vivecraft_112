...
public class Installer extends JPanel  implements PropertyChangeListener
{
    ...
    private static final String OF_FILE_NAME      = "1.12.2_HD_U_C9";
    private static final String OF_JSON_NAME      = "1.12.2_HD_U_C9";
    private static final String OF_MD5            = "3f3d4e04f0abe548009535e6ad094adb";
	...
	class InstallTask extends SwingWorker<Void, Void>{
		...
		public Void doInBackground()
		{
			...
			for(File f : targetDir.listFiles()){
				if(f.getName().equalsIgnoreCase("multimc.exe") || (f.getName().equalsIgnoreCase("multimc") && f.isFile())){
