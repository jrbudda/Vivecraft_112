...
public class GuiVRControls extends BaseGuiSettings {
    ...
    public void initGui() {
        ...
        btnLeftTouchpadMode = (new GuiButtonEx(103, this.width / 2 - 171, 38, 170, 20, ""));
        btnRightTouchpadMode = (new GuiButtonEx(104, this.width / 2 + 1, 38, 170, 20, ""));
